(() => {
    ...
    (i.m = s),
        ...
        (i.f = {}),
        (i.e = (t) => Promise.all(Object.keys(i.f).reduce((e, s) => (i.f[s](t, e), e), []))),
        (i.u = (t) => {
        ...
        (i.l = (s, a, n, r) => {
            if (t[s]) t[s].push(a);
                ...
                l || ((h = !0), ((l = document.createElement("script")).charset = "utf-8"), (l.timeout = 120), i.nc && l.setAttribute("nonce", i.nc), l.setAttribute("data-webpack", e + n), (l.src = s)), (t[s] = [a]);
                var p = (e, a) => {
                    (l.onerror = l.onload = null), clearTimeout(u);
                    var i = t[s];
                    if ((delete t[s], l.parentNode && l.parentNode.removeChild(l), i && i.forEach((t) => t(a)), e)) return e(a);
                },
        ...
        (() => {
            ...
            var e = (e, s) => {
                ...
                if (h) h(i);
                for (e && e(s); o < r.length; o++) (n = r[o]), i.o(t, n) && t[n] && t[n][0](), (t[r[o]] = 0);
            },
    ...
    const n = (t) => "[object Object]" === Object.prototype.toString.call(t),
        ...
        h = (t, e, s) => r("li", { class: t, html: `<a href="#" data-page="${e}">${s}</a>` }),
        o = (t, e) => {
            let s, a;
    ...
    class c {
        ...
        filter(t, e, s, a) {
            ...
            (i.data = r), this.rebuild(), i.update(), s || i.emit("datatable.sort", t, e);
        }
        sort(t, e, s) {
            const a = this.dt;
            ...
            Promise.all(u).then((i) => {
                ...
                Array.from(r).forEach((e) => {
                    const s = e.cells[t],
                        a = s.hasAttribute("data-content") ? s.getAttribute("data-content") : s.innerText;
                    let i;
                    (i = n ? n(a) : "string" == typeof a ? a.replace(/(\$|,|\s|%)/g, "") : a), parseFloat(i) == i ? (h[c++] = { value: Number(i), row: e }) : (l[d++] = { value: "string" == typeof a ? a.toLowerCase() : a, row: e });
                }),
                    e || (e = p.classList.contains("asc") ? "desc" : "asc"),
                    "desc" == e ? ((u = o(l, -1)), (g = o(h, -1)), p.classList.remove("asc"), p.classList.add("desc")) : ((u = o(h, 1)), (g = o(l, 1)), p.classList.remove("desc"), p.classList.add("asc")),
                    a.lastTh && p != a.lastTh && (a.lastTh.classList.remove("desc"), a.lastTh.classList.remove("asc")),
                    (a.lastTh = p),
                    (r = u.concat(g)),
                    (a.data = []);
                const f = [];
    ...
    const p = function (t) {
        ...
        u = {
            ...
            hiddenHeader: !1,
            footer: !1,
            labels: { placeholder: "Buscar...", perPage: "{select} registros por página", noRows: "Esta tabla está vacía", info: "Mostrando del {start} al {end} de un total de {rows} registros" },
    ...
    class g {
        constructor(t, e = {}) {
            if (
                ((this.initialized = !1),
                    (this.options = { ...u, ...e, layout: { ...u.layout, ...e.layout }, labels: { ...u.labels, ...e.labels } }),
                ...
                setTimeout(() => {
                    this.emit("datatable.init"),
                        ...
                        Object.entries(this.options.plugins).forEach(([t, e]) => {
                            this[t] && "function" == typeof this[t] && ((this[t] = this[t](e, { createElement: r })), e.enabled && this[t].init && "function" == typeof this[t].init && this[t].init());
                        });
                }, 10);
        }
        render(t) {
            ...
            if (
                (e.data && p.call(this),
                    ...
                    this.body || ((this.body = r("tbody")), this.table.appendChild(this.body)),
            ...
            if (
                ((this.headings = []),
                    ...
                    e.footer ? this.head && !this.foot && ((this.foot = r("tfoot", { html: this.head.innerHTML })), this.table.appendChild(this.foot)) : this.foot && this.table.removeChild(this.table.tFoot),
                    (this.wrapper = r("div", { class: "dataTable-wrapper dataTable-loading" })),
        ...
        renderPage() {
            ...
            let t,
                ...
                a = 0;
            if (
                (this.totalPages && ((e = this.currentPage - 1), (s = e * this.options.perPage), (a = s + this.pages[e].length), (s += 1), (t = this.searching ? this.searchData.length : this.data.length)),
        ...
        renderPager() {
            if ((l(this.pagers), this.totalPages > 1)) {
                ...
                this.options.firstLast && e.appendChild(h(t, 1, this.options.firstText)), this.options.nextPrev && e.appendChild(h(t, s, this.options.prevText));
                let i = this.links;
                this.options.truncatePager &&
                    (i = ((t, e, s, a, i) => {
                        ...
                        const d = [],
                            c = [];
                        e < 4 - a + l ? (o = 3 + l) : e > s - (3 - a + l) && (h = s - (2 + l));
                        for (let e = 1; e <= s; e++)
                            if (1 == e || e == s || (e >= h && e <= o)) {
                                const s = t[e - 1];
                            ...
                            d.forEach((e) => {
                                ...
                                if (n) {
                                    ...
                                    if (s - e == 2) c.push(t[e]);
                                        ...
                                        const t = r("li", { class: "ellipsis", html: `<a href="#">${i}</a>` });
                                        c.push(t);
                                    }
                                }
                                c.push(e), (n = e);
                    ...
                    this.links[this.currentPage - 1].classList.add("active"),
                    this.options.nextPrev && e.appendChild(h(t, a, this.options.nextText)),
                    this.options.firstLast && e.appendChild(h(t, this.totalPages, this.options.lastText)),
            ...
            (this.labels = []),
                ...
                this.headings.forEach((t, e) => {
                    if (
                        ...
                        const e = r("a", { href: "#", class: "dataTable-sorter", html: t.innerHTML });
        ...
        fixColumns() {
            if ((this.options.scrollY.length || this.options.fixedColumns) && this.activeHeadings && this.activeHeadings.length) {
                ...
                if (((this.columnWidths = []), this.table.tHead)) {
                    if (
                        (this.options.scrollY.length && ((e = r("thead")), e.appendChild(r("tr")), (e.style.height = "0px"), this.headerTable && (this.table.tHead = this.headerTable.tHead)),
        ...
        export(t) {
            ...
            if (o.type) {
                if ((("txt" !== o.type && "csv" !== o.type) || (s[0] = this.header), o.selection))
                    if (isNaN(o.selection)) {
                        if (Array.isArray(o.selection)) for (i = 0; i < o.selection.length; i++) s = s.concat(this.pages[o.selection[i] - 1]);
                    ...
                    if ("txt" === o.type || "csv" === o.type) {
                        for (l = "", i = 0; i < s.length; i++) {
                            for (r = 0; r < s[i].cells.length; r++)
                                if (!o.skipColumn.includes(e[r].originalCellIndex) && this.columns(e[r].originalCellIndex).visible()) {
                                    let t = s[i].cells[r].textContent;
                                    (t = t.trim()), (t = t.replace(/\s{2,}/g, " ")), (t = t.replace(/\n/g, "  ")), (t = t.replace(/"/g, '""')), (t = t.replace(/#/g, "%23")), t.includes(",") && (t = `"${t}"`), (l += t + o.columnDelimiter);
                                }
                            (l = l.trim().substring(0, l.length - 1)), (l += o.lineDelimiter);
                        }
                        (l = l.trim().substring(0, l.length - 1)), o.download && (l = `data:text/csv;charset=utf-8,${l}`);
                    } else if ("sql" === o.type) {
                        for (l = `INSERT INTO \`${o.tableName}\` (`, i = 0; i < e.length; i++) !o.skipColumn.includes(e[i].originalCellIndex) && this.columns(e[i].originalCellIndex).visible() && (l += `\`${e[i].textContent}\`,`);
                        for (l = l.trim().substring(0, l.length - 1), l += ") VALUES ", i = 0; i < s.length; i++) {
                            for (l += "(", r = 0; r < s[i].cells.length; r++) !o.skipColumn.includes(e[r].originalCellIndex) && this.columns(e[r].originalCellIndex).visible() && (l += `"${s[i].cells[r].textContent}",`);
                            (l = l.trim().substring(0, l.length - 1)), (l += "),");
                        }
                        (l = l.trim().substring(0, l.length - 1)), (l += ";"), o.download && (l = `data:application/sql;charset=utf-8,${l}`);
                    } else if ("json" === o.type) {
                        for (r = 0; r < s.length; r++)
                            for (a[r] = a[r] || {}, i = 0; i < e.length; i++) !o.skipColumn.includes(e[i].originalCellIndex) && this.columns(e[i].originalCellIndex).visible() && (a[r][e[i].textContent] = s[r].cells[i].textContent);
                        (l = JSON.stringify(a, o.replacer, o.space)), o.download && (l = `data:application/json;charset=utf-8,${l}`);
                    }
                    return (
                        o.download &&
        ...
        setMessage(t) {
            ...
            this.hasRows ? (e = this.data[0].cells.length) : this.activeHeadings.length && (e = this.activeHeadings.length),
                ...
                (this.totalPages = 0),
                this.render("pager"),
                this.clear(r("tr", { html: `<td class="dataTables-empty" colspan="${e}">${t}</td>` }));
        }
        columns(t) {
            return new c(this, t);
        }
        ...
        if (!s) {
            if (
                ...
                (s = (function (t, e) {
                    ...
                    if ("Arguments" === s || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s)) return b(t, e);
                })(t)) ||
    ...
    function y() {
        ...
        try {
            for (e.s(); !(t = e.n()).done;) {
                var s;
                (s = t.value.classList).add.apply(s, ["pagination", "pagination-primary"]);
            }
        } catch (t) {
            e.e(t);
        } finally {
    ...
    m.on("datatable.init", function () {
        var t;
        (t = m.wrapper.querySelector(".dataTable-selector")).parentNode.parentNode.insertBefore(t, t.parentNode), t.classList.add("form-select"), y();
    }),
